...
public static void main(String crecket[]){
	...
	String top1BtM[]={"Babar Azam","Rassie van der dussen","David warner","virat kohli","rohith sharma","steve smith",
                          "Alex carey","rahmat shah","travis head","imam-ul-haq"};
	String top10IcTeR[]={"Pakisthan","India","England","Australia","South Africa",
                          "new zewland","west indians","Afghanistan","Sri Lanka","Bangladesh"};
	String iplTeamN[]={"chennai super king","royal chanllenges bangalore","Mumbai indians","Gujarat titans","Kotkath Knight riders",
